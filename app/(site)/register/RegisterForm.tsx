  ...
  return (
    <main className="t-main">
      <div className="t-auth-container">
        <AuthHero
          image="/assets/images/rwanda_travel_hero.jpg"
          badge="Discover Rwanda"
          title="Join thousands of travelers exploring Rwanda."
          description="Create your account to sync your saved places across devices, write reviews, and customize your travel experience."
          stats={[
